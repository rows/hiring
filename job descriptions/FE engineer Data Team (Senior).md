...
Your role is to team up with our engineers and build computation components that solve challenges for business users. By joining our Data group team, you will contribute to helping users learn and extract the maximum value from data they can obtain via Integrations and manual manipulation and store it in their spreadsheet.
